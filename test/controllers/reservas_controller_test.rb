...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { data_inicial: @reserva.data_inicial, nivel_tanque: @reserva.nivel_tanque, quilometragem_inicial: @reserva.quilometragem_inicial } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { data_inicial: @reserva.data_inicial, nivel_tanque: @reserva.nivel_tanque, quilometragem_inicial: @reserva.quilometragem_inicial } }
