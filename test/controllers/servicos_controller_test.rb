...
class ServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post servicos_url, params: { servico: { abastecimento: @servico.abastecimento, tipo: @servico.tipo } }
    end
  ...
  test "should update servico" do
    patch servico_url(@servico), params: { servico: { abastecimento: @servico.abastecimento, tipo: @servico.tipo } }
