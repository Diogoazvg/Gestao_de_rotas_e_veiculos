...
class ReservasTest < ApplicationSystemTestCase
  ...
  test "creating a Reserva" do
    ...
    fill_in "Data Inicial", with: @reserva.data_inicial
    fill_in "Nivel Tanque", with: @reserva.nivel_tanque
    fill_in "Quilometragem Inicial", with: @reserva.quilometragem_inicial
